...
>
  <div class="flex items-center gap-3 h-full px-6 max-w-6xl mx-auto">
    ...
    <div class="relative flex-shrink-0" use:clickOutside>
      <!-- Expanded Panel (appears above) -->
      {#if showSimSelector}
        <div
          class="absolute bottom-full mb-2 left-0 w-80
        ...
        >
          <!-- Header -->
          <div
            class="px-4 py-3 bg-gray-50/50 dark:bg-zinc-800/50 border-b border-gray-200 dark:border-zinc-700"
          >
          ...
          <div class="px-4 py-3 border-b border-gray-100 dark:border-zinc-800">
            <div class="relative">
              ...
              <input
                ...
                class="w-full pl-9 pr-3 py-2 bg-gray-50 dark:bg-zinc-800
          ...
          <!-- SIM Cards List -->
          <div class="max-h-64 overflow-y-auto bg-white dark:bg-zinc-900/50">
            <div class="py-2">
      ...
      <button
        onclick={toggleSimSelector}
        class="flex items-center gap-2 px-4 h-12 min-w-[180px]
      ...
      >
        ...
        {/if}
        <Icon
          icon={showSimSelector ? "carbon:chevron-up" : "carbon:chevron-down"}
