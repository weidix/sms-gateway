...
>
  <div class="flex items-center gap-3 h-full px-6 max-w-6xl mx-auto">
    <!-- Combined Input and SIM Selector Container -->
    <div class="flex-1 flex items-center gap-3 relative">
      <!-- SIM Card Selector -->
      <div class="relative" use:clickOutside>
        <!-- Button Container with dynamic width -->
        <div
          class="relative bg-gray-50 dark:bg-zinc-800
        ...
        <!-- Dropdown Content (positioned absolutely above the button) -->
        {#if expandedContent}
          <div
            class="absolute bottom-full mb-2 left-0 w-80 bg-gray-50 dark:bg-zinc-800
          ...
          >
            ...
            <!-- SIM Cards List -->
            <div class="max-h-56 overflow-y-auto rounded-b-xl">
              <div class="py-1">
